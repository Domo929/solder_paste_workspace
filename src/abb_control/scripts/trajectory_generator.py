...
class Arm:
    def __init__(self, arm_name, n):
        ...
        gripper_len = 0.2
        hot_air_len = 0.373
        self.M_end = [[0, 0, 1, 0.374], [0, 1, 0, 0], [-1, 0, 0, 0.63], [0, 0, 0, 1]]
        self.M_camera = [[0, 0, 1, 0.374], [0, 1, 0, 0], [-1, 0, 0, 0.63], [0, 0, 0, 1]]
        self.M_needle = [[0, 0, 1, 0.374 + needle_len], [0, 1, 0, 0], [-1, 0, 0, 0.63], [0, 0, 0, 1]]
        self.M_gripper = [[0, 0, 1, 0.374 + gripper_len], [0, 1, 0, 0], [-1, 0, 0, 0.63], [0, 0, 0, 1]]
    ...
    def move_joint_traj(self, traj, dt):
        ...
        goal.goal.trajectory.joint_names = ['joint_1', 'joint_2', 'joint_3', 'joint_4', 'joint_5', 'joint_6']
