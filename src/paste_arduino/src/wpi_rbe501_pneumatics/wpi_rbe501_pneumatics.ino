...
void ROS_Cmd_Callback(const std_msgs::Byte& ROS_Cmd_msg){
    ...
    ROS_V1_Cmd = ROS_Cmd_msg.data & 1000;
    ROS_V2_Cmd = ROS_Cmd_msg.data & 0100;
    ROS_V3_Cmd = ROS_Cmd_msg.data & 0010;
    ROS_V4_Cmd = ROS_Cmd_msg.data & 0001;
}

// Instantiate ROS Subscribers
ros::Subscriber<std_msgs::Byte> ROS_Valve_Sub("ROS Valve Commands", &ROS_Cmd_Callback);

// Initialize ROS Publishers
std_msgs::Byte ROS_Status_msg;      // ROS Feedback Message

// Instantiate ROS Publishers
ros::Publisher ROS_Valve_Pub("ROS Valve Status", &ROS_Status_msg);  
